...
const Dock = ({ setWindowState}) => {
  return (
    <footer className="dock">
      ...
      <div   onClick={()=>{window.open("mailto:ashish@example.com","_blank")}} className="icon mail">
        <img src="/doc-icons/mail.svg" alt="" />
      </div>
      <div  onClick={()=>{window.open("https://www.linkedin.com/in/ashish-saxena-918a5930b/","_blank")}} 
       className="icon link">
